...
namespace TalentGoWebApp
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(() => new TalentGoDbContext());
            app.CreatePerOwinContext<ApplicationUserManager>(AspnetIdentityFactory.CreateUserManager);
            app.CreatePerOwinContext<ApplicationSignInManager>(AspnetIdentityFactory.CreateApplicationSignInManager);
