...
namespace TalentGoWebApp.Areas.Mgmt.Controllers
{
    ...
    public class BaseDataController : Controller
    {
        ...
        ArchiveCategoryManager archManager;

        public BaseDataController(ArchiveCategoryManager archiveManager)
        {
            this.archManager = archiveManager;
        }

        // GET: Mgmt/BaseData
        public ActionResult Index()
        {
            return View(this.archManager.ArchiveCategories);
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Update(int id, ArchiveCategory model)
        {
            await this.archManager.UpdateArchiveCategory(model);
            return RedirectToAction("Index");
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Create(ArchiveCategory model)
        {
            ...
            await this.archManager.CreateArchiveCategory(model);
        ...
        public async Task<ActionResult> UploadFiles(int acid)
        {
            ...
            using (var ms = new MemoryStream())
            {
                ...
                await this.archManager.UpdateArchiveCategory(archiveCategory);
        ...
        public async Task<ActionResult> RemoveFile(int eaid)
        {
            ...
            await this.archManager.UpdateArchiveCategory(current);
            try
            {
